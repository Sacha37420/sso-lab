...
CREATE SCHEMA IF NOT EXISTS robot_lab;

CREATE SCHEMA IF NOT EXISTS code_route;

CREATE SCHEMA IF NOT EXISTS craft_lab;

CREATE SCHEMA IF NOT EXISTS bilan_thermique;

CREATE SCHEMA IF NOT EXISTS oauth_hub;
